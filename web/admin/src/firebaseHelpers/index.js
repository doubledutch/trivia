...
// the firebase key.
export function mapPushedDataToStateObjects(fbc, ref, component, stateKey, keyFn) {
...
export function mapPushedDataToObjectOfStateObjects(fbc, ref, component, stateKey, keyFn, subKeyFn) {
  ref.on('child_added', onData)
  ref.on('child_changed', onData)
  ref.on('child_removed', onDataDeleted)
